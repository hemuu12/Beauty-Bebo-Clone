...
function myFun(){
    alert("Reset password service is temporarily unavailable. You'll have to create a new account.")
    location.href="signup.html"
}

document.querySelector("#btn2").addEventListener("click", newsFun);

function newsFun(){
    alert("You're succesfully registered with our News service.");
