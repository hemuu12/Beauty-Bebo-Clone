document.querySelector("div>h5").addEventListener("click", onclicking)

let addreesarray = JSON.parse(localStorage.getItem("fulladdress")) || []

function onclicking() {
    event.preventDefault()

    let studata = {
        frstnm: document.querySelector("#firstname").value,
        lstnm: document.querySelector("#lastname").value,
        stradrs: document.querySelector("#streetaddress").value,
        city: document.querySelector("#city").value,
        state: document.querySelector("#state").value,
        postcode: document.querySelector("#poscode").value,
        country: document.querySelector("#country").value,
        phnno: document.querySelector("#phone").value,
    }
    addreesarray.push(studata)
    console.log(addreesarray)

    localStorage.setItem("fulladdress", JSON.stringify(addreesarray))
