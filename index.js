...
function showData_product(){
    demoarray.forEach(function(el){
      let div1 = document.createElement("div")
      div1.setAttribute("class", "subpart1")
     let ig = document.createElement("img")
        ig.src=el.image
     let descri = document.createElement("p")
      descri.innerText=el.name
      let div2 = document.createElement("div")
      div2.setAttribute("class", "star")
     ...
     div2.append(i1, i2, i3, i4, i5)
     let div3 = document.createElement("div")
     div3.setAttribute("class", "price-product")
     let span1 = document.createElement("span")
     span1.innerText="₹100"
     span1.setAttribute("class", "a-amount")
     let p1 = document.createElement("p")
     p1.innerText=`₹${el.price}`
     p1.setAttribute("class", "actual_price")
     let span2 = document.createElement("span")
     span2.innerText="5% off"
     span1.setAttribute("class", "d-amount")
      div3.append(span1, p1, span2)
  
     let div4 = document.createElement("div")
     div4.setAttribute("class", "buy")
     ...
     tag_i.setAttribute('class', 'fa-solid fa-bag-shopping')
    ...
    i6.setAttribute("class", "fa fa-solid fa-heart")
    btn2.append(i6)
    div4.append(btn, btn2)  
   
   div1.append(ig, descri, div2, div3, div4)
  document.querySelector("#part6-home").append(div1)


//  document.querySelector(".buy").append(btn)

    })
}
 let proLS = JSON.parse(localStorage.getItem("surajKumarData")) || []
