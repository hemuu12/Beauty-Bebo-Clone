document.querySelector("#cod").addEventListener("click", clickcod)

let totalprice = Number(localStorage.getItem("subtotalvalue"))
let incgst = totalprice + 65.29

// console.log(typeof(totalprice))

document.querySelector("#cartsubtotal").innerText = "₹" + totalprice + ".00"
document.querySelector("#incgst").innerText = "₹" + incgst
document.querySelector("#excgst").innerText = "₹" + totalprice + ".00"

let preaddreesarray = JSON.parse(localStorage.getItem("fulladdress"))

function clickcod() {

    let maindivbtn = document.createElement("div")
    maindivbtn.setAttribute("id", "maindivbtn")
    maindivbtn.innerText = "PLACE ORDER"
    maindivbtn.addEventListener("click", orderconfirmpage)

    function orderconfirmpage() {
        window.location.href = "confirmorder.html"
    }

    let inladiv = document.createElement("div")
    let input = document.createElement("input")
    input.setAttribute("type", "checkbox")
    let label = document.createElement("label")
    label.setAttribute("for", "1")
    label.innerText = "My billing and shipping address are the same"

    inladiv.append(input, label)

    document.querySelector("#inlabetween").append(inladiv)



    btndiv.append(maindivbtn)


}

preaddreesarray.forEach(function (elem) {


    document.querySelector("#addressdiv").innerHTML = ""

    let div1 = document.createElement("div")
    div1.innerText = elem.frstnm + " " + elem.lstnm
    let div2 = document.createElement("div")
    div2.innerText = elem.stradrs
    let div3 = document.createElement("div")
    div3.innerText = elem.city + "," + "Assam" + " " + elem.postcode
    let div4 = document.createElement("div")
    div4.innerText = elem.country
    let div5 = document.createElement("div")
    div5.innerText = elem.phnno

    document.querySelector("#addressdiv").append(div1, div2, div3, div4, div5)
...
function APPLYDISCOUNT() {
    ...
    //     document.querySelector("#cartsubtotal").innerText =""
    // document.querySelector("#incgst").innerText =""
    // document.querySelector("#excgst").innerText = ""
    let coupon = document.querySelector(".coupon").value
    let h6 = document.querySelector("#h6")


    if (coupon === "hilton") {
        document.querySelector("#cartsubtotal").innerText = "₹" + totalprice
        document.querySelector("#incgst").innerText = "₹" + totalprice
        document.querySelector("#excgst").innerText = "₹" + totalprice
